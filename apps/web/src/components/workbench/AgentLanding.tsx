...
export function AgentLanding({
  ...
  return (
    <div className={`flex min-h-0 flex-col justify-center overflow-y-auto overscroll-contain py-2 ${compactOnMobile ? "min-h-[420px] flex-none sm:min-h-0 sm:flex-1" : "flex-1"}`}>
      ...
      <div className={`agent-showcase min-h-0 shrink-0 items-center sm:pt-7 lg:pt-8 ${compactOnMobile ? "pt-4" : "pt-6"}`}>
        ...
        <div className={`agent-feature-card group mx-auto flex w-full max-w-[640px] flex-col justify-center overflow-y-auto rounded-3xl border border-cyan-300/70 bg-white/65 p-4 shadow-xl shadow-cyan-950/10 backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-cyan-400 hover:bg-white/75 hover:shadow-2xl hover:shadow-cyan-950/15 dark:border-cyan-400/30 dark:bg-transparent dark:shadow-black/30 dark:hover:bg-cyan-400/[0.04] sm:min-h-[300px] sm:p-6 lg:max-h-none lg:min-h-[330px] lg:p-7 ${compactOnMobile ? "min-h-[220px] max-h-[260px]" : "min-h-[260px] max-h-[330px]"}`}>
